...
//JS Google Sheets Form
const scriptURL =
  "https://script.google.com/macros/s/AKfycbwDFO9Aod4mcw_NUwMs-EDMnA21GFFVI5TptwM70ENBSzNNQhbuCul-YIw2HbSkAvx6ng/exec";
...
function ValidateEmail(inputText) {
  ...
  if (inputText.value.match(mailformat)) {
    ...
    document.forms["submit-to-google-sheet"]["email"].focus();
    return true;
  } else {
    document.getElementById("message-status").innerHTML =
